...
def load_data(filepath):
    with open(filepath, encoding="utf-8") as file:  # Specify UTF-8 encoding
        data = json.load(file)
    return data
...
def train_model(model, training_data, output_data, epochs=10000, lr=0.001):
...
def main():
    data = load_data(r"C:\Users\tchigurupati\OneDrive\Documents\MINOR\intents.json")
